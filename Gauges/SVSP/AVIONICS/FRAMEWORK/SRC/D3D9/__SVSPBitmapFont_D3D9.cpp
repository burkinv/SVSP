#include "__SVSPBitmapFont_D3D9.h"
...
__SVSPBitmapFont_D3D9::__SVSPBitmapFont_D3D9(const LPSTR pcFontName, DWORD dwHeight, DWORD dwFlags) : __SVSPFont(pkGraphics, sFontName, dwHeight, dwFlags)
{
...
__SVSPBitmapFont_D3D9::~__SVSPBitmapFont_D3D9() 
{
  Release();
...
VOID __SVSPBitmapFont_D3D9::SetTransform(struct D3DXMATRIX *pkTransformMatrix)
{
  m_pkDevice->SetTransform(pkDevice, D3DTS_WORLD, pkTransformMatrix);
}

VOID __SVSPBitmapFont_D3D9::Begin()
{
}

VOID __SVSPBitmapFont_D3D9::End()
{
}

VOID __SVSPBitmapFont_D3D9::Release()
{
...
HRESULT __SVSPBitmapFont_D3D9::Reset()
{
  /////////////////////////////////////////////////////////////////////
  // CREATE VERTEX BUFFER
  /////////////////////////////////////////////////////////////////////
  m_hResult = m_pkDevice->CreateVertexBuffer(__SVSPBitmapFont_D3D9::NUM_TEXT_RECT_VERTICES*sizeof(FONT3DVERTEX), 
  ...
  for( UINT which=0; which<2; which++ )
  {
    ...
    m_pkDevice->SetTexture(pkDevice,  0, m_pkFontBitmapTexture );
...
VOID __SVSPBitmapFont_D3D9::RenderText( const TCHAR* strText, struct D3DXVECTOR3 *v, DWORD dwFlags, FLOAT fScaling)
{
  FLOAT tx1;
  FLOAT ty1;
  FLOAT tx2;
 ...
 // //// Set filter states
 // //if( dwFlags & __SVSPFont::FILTERED )
 // //{
 // //  m_pkDevice->SetSamplerState( 0, D3DSAMP_MINFILTER, D3DTEXF_LINEAR );
 // //  m_pkDevice->SetSamplerState( 0, D3DSAMP_MAGFILTER, D3DTEXF_LINEAR );
  ...
  while( (c = *strText++) != 0 )
  {
    ...
    if( c != _T(' ') )
    {
      ...
      *pkVerts = InitFont3DVertex( D3DXVECTOR3(x+0,y+h,z), D3DXVECTOR3(0,0,-1), tx1, ty1 ); pkVerts++;
      ...
      if( dwNumTriangles*3 > (__SVSPBitmapFont_D3D9::NUM_TEXT_RECT_VERTICES - 6) )
      {
...
VOID __SVSPBitmapFont_D3D9::RenderText( const TCHAR* strText, DWORD dwFlags, FLOAT fScaling)
{
  RenderText(strText, &D3DXVECTOR3(0, 0, 0), dwFlags, fScaling);
}

HRESULT __SVSPBitmapFont_D3D9::GetTextExtent( const TCHAR* strText, DWORD dwFlags, SIZE* pSize )
{
...
HRESULT __SVSPBitmapFont_D3D9::PaintAlphabet( HDC hDC, BOOL bMeasureOnly )
{
  SIZE size;
