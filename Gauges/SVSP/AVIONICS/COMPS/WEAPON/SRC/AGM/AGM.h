#ifndef __AGM_MODULE_H__
#define __AGM_MODULE_H__
...
public:
  ...
  static const AAVVector3<FLOAT>  AIR_RESISTANCE_FACTOR;
                             ...
                             AGM(CHAR *pcName, UINT uiStationID, UINT uiUnitID, UINT uiWeight, __SVSPAvionics *pkAvionics, AAVVector3<FLOAT> &rkPilonVector, AAVVector3<FLOAT> &rkPilonAttitude);
  virtual                   ~AGM();
  virtual VOID               Render(D3DXMATRIX &rkOPMatrix);

};

#endif	/* __AGM_MODULE_H__ */
