#ifndef __HARM_MODULE_H__
#define __HARM_MODULE_H__

#include "MISSILE.h"

class HARM : public MISSILE
{
public:
  ...
  static const AAVVector3<FLOAT>   AIR_RESISTANCE_FACTOR;
                             ...
                             HARM(CHAR *pcName, UINT uiStationID, UINT uiUnitID, UINT uiWeight, __SVSPAvionics *pkAvionics, AAVVector3<FLOAT> &rkPilonVector, AAVVector3<FLOAT> &rkPilonAttitude);
  virtual                   ~HARM();
  virtual VOID               Render(D3DXMATRIX &rkOPMatrix);

};

#endif	/* __HARM_MODULE_H__ */
